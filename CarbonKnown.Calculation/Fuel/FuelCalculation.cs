        ...
        public static IDictionary<FuelType, IDictionary<UnitOfMeasure, Guid>> FactorMapping =
            new SortedDictionary<FuelType, IDictionary<UnitOfMeasure, Guid>>
            {
                ...
                },
                {
                    ...
                    {
                        {UnitOfMeasure.Tonnes, FactorIds.Fuel.MarineFuelOilTonnes}
                    }
                },
                {
                    FuelType.HeavyFuelOil, new SortedDictionary<UnitOfMeasure, Guid>
                    {
                        {UnitOfMeasure.Kilograms, FactorIds.Fuel.HeavyFuelOil}
                    }
                },
                {
                    FuelType.Paraffin, new SortedDictionary<UnitOfMeasure, Guid>
                    {
                        {UnitOfMeasure.Litres, FactorIds.Fuel.Paraffin}
                    }
                },
                {
                    FuelType.LNGkWH, new SortedDictionary<UnitOfMeasure, Guid>
                    {
                        {UnitOfMeasure.KiloWattHours, FactorIds.Fuel.LNGKWH},
                        {UnitOfMeasure.Litres, FactorIds.Fuel.LNGLitres},
                        {UnitOfMeasure.Tonnes, FactorIds.Fuel.LNGTonnes}
                    }
                },
                {
                ...
                },
                {
                    ...
                    {
                        {UnitOfMeasure.Gigajoules, FactorIds.Fuel.LPGGigajoules}
                    }
                },
            };
